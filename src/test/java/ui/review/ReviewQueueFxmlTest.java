...
class ReviewQueueFxmlTest {
    ...
    void fxmlContainsRequiredControls() throws Exception {
        ...
        final Set<String> expectedIds = Set.of(
                ...
                "pageSizeComboBox",
                "refreshButton",
                "processReadyPageButton",
                "readyPageBatchStatusLabel",
                "readyPageBatchResultsList",
                "unassignedMediaPane",
                "queueTable",
                "filenameColumn",
                "matchStatusColumn",
    ...
    @Test
    @DisplayName("FXML exposes context candidate review entry point")
    void fxmlContainsContextCandidateEntryPoint() throws Exception {
        Assertions.assertTrue(hasFxId(document(), "contextCandidatesMenuItem"));
    }
